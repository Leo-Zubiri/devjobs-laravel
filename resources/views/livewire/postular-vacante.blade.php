<div class="bg-gray-300 p-5 mt-10 flex flex-col justify-center items-center rounded">
    <h3 class="text-center text-2xl font-bold my-4">
        Postularme a esta vacante
    </h3>

    @if (session()->has('mensaje'))
        <p class="uppercase  border-green-600 bg-green-100  text-green-600 font-bold p-2 rounded-lg">
            {{ session('mensaje') }}
        </p>
    @else
